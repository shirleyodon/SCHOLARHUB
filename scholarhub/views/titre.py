...
from .. import db
from ..utils import titre_to_dict_2, get_all_titre, get_titre, create_titre, update_titre
...
def create_or_get_all_titres():
    if request.method == "GET":
        try:
            ...
            return jsonify([titre_to_dict_2(titre) for titre in titres]), 200
...
def get_or_update_or_delete_titre(codeTitre):
    try:
        ...
        if not titre:
            ...
            if request.method == "GET":
                return jsonify(titre_to_dict_2(titre))
