...
from .. import db
from ..utils import parcours_to_dict_2, get_all_parcours, get_parcours, create_parcours, \
    update_parcours
...
def create_or_get_all_parcours():
    if request.method == "GET":
        try:
            ...
            return jsonify([parcours_to_dict_2(parc) for parc in parcours]), 200
...
def get_or_update_or_delete_parcours(numParc):
    try:
        ...
        if not parcours:
            ...
            if request.method == "GET":
                return jsonify(parcours_to_dict_2(parcours))
