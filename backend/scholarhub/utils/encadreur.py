...
def create_encadreur(json_data):
    return EncadreurPedagogique(
        ...
        json_data.get('MotPasseEncad') if json_data.get('MotPasseEncad') else None,
...
def update_encadreur(encad, json_data):
    ...
    encad.emailEncad = json_data.get('EmailEncad') if json_data.get('EmailEncad') else None
    encad.motPasseEncad = json_data.get('MotPasseEncad') if json_data.get('MotPasseEncad') else None
