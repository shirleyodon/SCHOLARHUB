...
from .. import db
from ..utils import etablissement_to_dict_1, get_all_etablissement, get_etablissement, \
...
def create_or_get_all_etablissements():
    if request.method == "GET":
        try:
            ...
            return jsonify([etablissement_to_dict_1(etab) for etab in etablissements]), 200
...
def get_or_update_or_delete_etablissement(idEtab):
    try:
        ...
        if not etablissement:
            ...
            if request.method == "GET":
                return jsonify(etablissement_to_dict_1(etablissement)), 200
